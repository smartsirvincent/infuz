    ...
    <main className="space-y-8">
      <div className="card">
        ...
        <p className="mt-2 text-sm text-stone-600">
          從產品 / 模特兒 / 情境資料庫各選 1 項,AI 合成 <strong>1:1 一張視覺</strong>。
        </p>
      </div>
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          <div className="flex items-start gap-4">
            <div className="flex size-14 items-center justify-center rounded-xl bg-emerald-100 text-3xl">👕</div>
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-stone-900 group-hover:text-emerald-700">單件素材</h2>
              <p className="mt-1 text-xs text-stone-600">1 件衣服 + 1 模特 + 1 情境</p>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="flex size-14 items-center justify-center rounded-xl bg-purple-100 text-3xl">👯</div>
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-stone-900 group-hover:text-purple-700">搭配素材</h2>
              <p className="mt-1 text-xs text-stone-600">上衣 + 下身 + 1 模特 + 1 情境</p>
              <p className="mt-3 text-xs text-stone-500">
                適合 OOTD、整套穿搭、季節 lookbook。
              </p>
            </div>
          </div>
        </Link>
