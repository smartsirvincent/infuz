...
3. ⚠️ **persona_narrative (情境角色文,用第三方角色觀察) 最多 1 個** (8 主題裡只能有 1 個,5 主題裡可以是 0 個)
   - 角色觀察視角很容易讓貼文看起來都一樣,不要過度使用
   - 「故事型」內容也可以走「客戶見證 (第三人稱「客人XX說」+ 引述)」或「自言自語 (第一人稱內心戲)」,不只 persona_narrative 一條路
4. 排程時間要錯開,避免擠在同一時段
5. 每個主題給推薦篇數(預設 30/月,但語錄類可以多、產品類較少)
6. 平台預設 Threads,若用戶選 IG/FB 則部分主題選擇性勾選
